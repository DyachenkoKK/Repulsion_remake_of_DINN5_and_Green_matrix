module LU_Gaussian_elimination
implicit none

    contains
    
    subroutine get_determinant_by_LU_Gaussian_elimination(A, A_size, n, result_)
    implicit none
        ...
        return
    end subroutine get_determinant_by_LU_Gaussian_elimination
    
    

end module LU_Gaussian_elimination
