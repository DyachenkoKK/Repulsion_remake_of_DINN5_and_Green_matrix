module test_get_solution_by_Gram_Schmidt_solver    
implicit none
    ...
    subroutine test_Gram_Schmidt_solver
    ...
    end subroutine test_Gram_Schmidt_solver
    ...
    subroutine test_speed_Gram_Schmidt_solver
    use polygone, only: STAR5_new
    implicit none
    ...
    end subroutine test_speed_Gram_Schmidt_solver
    
    
    
    
end module test_get_solution_by_Gram_Schmidt_solver